...
public:
  ...
  void setCursor(uint8_t c, uint8_t r);        // 'c' in alpha mode, should be an even column number
  void getCursor(uint8_t &c, uint8_t &r);
  ...
  void bitmap_h(uint8_t x0, uint8_t y0, uint8_t width, uint8_t height, const prog_uint8_t data[]);
